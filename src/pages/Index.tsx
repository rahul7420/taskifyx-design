        ...
        <Card className="w-full max-w-sm sm:max-w-md shadow-lg">
          ...
          <CardContent className="px-4 sm:px-6 text-center">
            <p className="mb-6 text-gray-600">
              Organize your tasks, track your progress, and increase your productivity with TaskifyX.
            </p>
            <Button onClick={handleGetStarted} className="w-full text-sm h-9 sm:h-10">
              Get Started
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </CardContent>
          <CardFooter className="flex flex-col px-4 pb-5 pt-0 sm:px-6 sm:pb-6 text-center text-xs text-gray-500">
            <p>
